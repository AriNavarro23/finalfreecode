function checkCashRegister(price, cash, register) {
    ...
    Object.keys(AMOUNTS).forEach((key) =>{
        if(amountDue > AMOUNTS[key]){
            ...
            if(difference > totalAmountInRegister){
...
checkCashRegister(19.5, 20, [["PENNY", 1.01], ["NICKEL", 2.05], ["DIME", 3.1], ["QUARTER", 0.0], ["ONE", 90], ["FIVE", 55], ["TEN", 20], ["TWENTY", 60], ["ONE HUNDRED", 100]]);
